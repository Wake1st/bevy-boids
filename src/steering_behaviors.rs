    ...
    fn set_steering_vector(&mut self, flockmates: &Vec<Vec2>) -> () {
        ...
        if flock_size == 0.0 {
            ...
            self.steering_vector =
                average_location / average_location.length() * self.effectiveness;
        }
    }
}
...
impl SteeringBehavior for Alignment {
    ...
    fn set_steering_vector(&mut self, flockmates: &Vec<Vec2>) -> () {
        ...
        if flock_size == 0.0 {
            ...
            self.steering_vector = average_heading * self.effectiveness;
        }
    }
}
...
impl SteeringBehavior for Cohesion {
    ...
    fn set_steering_vector(&mut self, flockmates: &Vec<Vec2>) -> () {
        ...
        if flock_size == 0.0 {
            ...
            self.steering_vector = average_location * self.effectiveness;
        }
    }
}
